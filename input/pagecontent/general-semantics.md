...
Additional Requirements / Detailed Examination Specifications (A.1.10.5) is another optional field that can contain extra information for the order. This could include, for example, the information logistics (IL) request for using a specific agreed-upon protocol or conducting the examination on a specific MRI machine.
