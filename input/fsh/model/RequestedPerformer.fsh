Logical: RequestedPerformerOrderCz
...
* organization 1..1 BackboneElement "A.1.6.4 - Requested Performer organisation" """The healthcare provider organisation information."""
* dateTime 1..1 dateTime "A.1.6.5 - Requested date and time" """Date and time of the request."""
